...
export default function SignInPage() {
  return (
    ...
    <div className="flex-1 flex items-center justify-center px-4!">
      ...
      <Card className="flex flex-col  w-[495px] h-[700px] rounded-sm bg-[#151515] border-0  inset-0 opacity-82 ">
        ...
        <CardContent>
          <form className=''>
            ...
            <div className="text-right w-full px-22!">
              <a
                href="#"
        ...
        <CardFooter className="flex flex-1 flex-col justify-center items-center">
          ...
          {/* Divider */}
          <div className="text-center  border-gray-700 w-full mt-14!">
