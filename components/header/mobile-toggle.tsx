    ...
    <Sheet open={mobileMenuOpen} onOpenChange={setMobileMenuOpen}>
      ...
      <SheetTrigger asChild>
        <Button
          variant="ghost"
          size="icon"
          className="md:hidden relative duration-200 hover:text-text-primary hover:scale-110 transition rounded-[6px] border h-7 px-1! backdrop-blur-2xl! border-white/30 bg-white/10 text-white"
        >
        ...
        <div className="flex-1 overflow-y-auto px-4 py-2 space-y-3 scrollbar-thin scrollbar-thumb-white/20">
          ...
          <div className="py-2! flex items-center gap-3">
            <Avatar className="h-10 w-10 rounded-[6px]">
              <AvatarImage src="avatars/Name=chicken.svg" className=" rounded-[6px]" />
          ...
          <nav className="flex-1 space-y-1!">
            ...
            <div className="space-y-1!">
              <Link
                ...
                transition-all duration-150 rounded-[6px] text-text-muted
            ...
            <div className="flex flex-wrap gap-2 py-2!">
              {languages.map((lang) => (
                <button
                  ...
                  className={`px-1! py-1! rounded-[6px] text-sm border-white/30 hover:text-white hover:scale-110 transition  ${
                    currentLang === lang
